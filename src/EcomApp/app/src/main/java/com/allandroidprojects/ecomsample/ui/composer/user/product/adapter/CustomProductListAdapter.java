...
public class CustomProductListAdapter
        extends RecyclerView.Adapter<CustomProductListAdapter.ViewHolder> {
    ...
    public CustomProductListAdapter(Context context, RecyclerView recyclerView, ArrayList<Product> items) {
        mValues = items;
